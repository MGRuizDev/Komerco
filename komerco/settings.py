"""
Django settings for komerco project.
...
SECRET_KEY = 't%qvg2dw*nr9_^3r4p41ng^nhkm5*1)-k$iw^+(rwoll6yd!r*'
...
WSGI_APPLICATION = 'komerco.wsgi.application'
